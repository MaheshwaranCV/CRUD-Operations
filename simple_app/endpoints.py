...
con_string = "mongodb+srv://maheshwarancv:Mahesh_0172002@cluster0.8nlahq3.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('demo')

user_collection = pymongo.collection.Collection(db, 'user') #(<database_name>,"<collection_name>")
